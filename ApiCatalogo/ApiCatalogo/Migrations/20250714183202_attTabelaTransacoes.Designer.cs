...
namespace ApiCatalogo.Migrations
{
    ...
    [Migration("20250714183202_attTabelaTransacoes")]
    partial class attTabelaTransacoes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiCatalogo.Model.Produto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProdutoId = 1,
                            CategoriaId = 1,
                            DataCadastro = new DateTime(2025, 7, 14, 15, 32, 2, 553, DateTimeKind.Local).AddTicks(1821),
                        ...
                        new
                        {
                            ProdutoId = 2,
                            CategoriaId = 2,
                            DataCadastro = new DateTime(2025, 7, 14, 15, 32, 2, 553, DateTimeKind.Local).AddTicks(1824),
                        ...
                        new
                        {
                            ProdutoId = 3,
                            CategoriaId = 3,
                            DataCadastro = new DateTime(2025, 7, 14, 15, 32, 2, 553, DateTimeKind.Local).AddTicks(1826),
